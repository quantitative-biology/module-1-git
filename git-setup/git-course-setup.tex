...
You can skip the remaining slides for now -- except please just do ``Install the difftool''.
...
\frame{\frametitle{Tips from Chris in 2021 but don't think we need it all now}
