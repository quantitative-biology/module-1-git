...
These are programs/things you will need (instructions will follow). Obviously skip any that you already have working.
...
* MAC
  ...
  2. Enjoy a beverage
  3. TODO: Check with testors if it is that simple

### Install the difftool

The difftool will be used to examine differences between different versions of
