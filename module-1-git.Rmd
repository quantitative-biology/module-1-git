...
There are several reasons you might want to use Git and Github. We will explain
these in order of difficulty. First, some definitions:
...
1.  your collaborator uses github--> navigating the site (R packages on github)
 2. you want to use github for version control ---> setting it up
 3. you want to use github to collaborate
...
```{r, echo = FALSE, fig.alt = "", width="50%"}
knitr::include_graphics("./images/hake-picture.png",error = FALSE)
```
...
* If possible, choose a user name that will make sense to colleagues, e.g. __andrew-edwards__ or __cgrandin__, not __pink-unicorn__ (unless this name makes a lot of sense to colleagues....).
