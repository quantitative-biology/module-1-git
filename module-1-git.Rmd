...
Each GitHub repository can be viewed on GitHub. We will first take a quick
...
So grab some popcorn and click on the screenshot below to watch Video 1, which
...
```{r, echo = FALSE, fig.alt = "Artist rendition of a Pacific Hake.", width="50%", fig.align = "center", fig.cap="Artist rendition of a Pacific Hake"}
...
and tables [(2022 assessment available
here)](https://media.fisheries.noaa.gov/2022-02/2022-hake-assessment-post-srg.pdf){target="_blank"}.
...
GitHub and automate a lot of the document production using knitr (knitr is similar to
R Markdown which is covered in the [R Markdown] module).
...
```{r, echo = FALSE, fig.alt = "Example screenshot of Track Changes in Word showing numerous crossings out and edits, which leave the reader where to start editing.", out.width="80%", fig.align = "center", fig.cap = "Example of numerous Track Changes in Word, leaving the reader unsure of how to proceed."}
...
```{r, echo = FALSE, fig.alt = "Screenshot of a directory containing multiple saved versions of a file, with names that include dates and initials, which can create confusion and edits getting missed.", out.width="80%", fig.align = "center", fig.cap = "Having multiple versions of the same file can easily lead to not all edits being considered."}
...
```{r, echo = FALSE, fig.cap = "Example of having to wait for colleagues to merge edits.", out.width="90%", fig.align = "center", fig.alt = "Example email exchange: I'm going to merge my draft bits to Carrie by 7:30pm, and she will merge my edits into hers. And then recirculate when she's ready."}
...
```{r, echo = FALSE, fig.alt = "Example email: Hi Andy, I'm not sure how Lesley is handling this. Paul and I had sent edits to her yesterday and I guess she will have to merge our edits with yours. I can just hear you saying something about GitHub...", fig.cap = "Example of having to manually manage multiple version of the same document.", out.width="90%", fig.align = "center"}
...
```{r, echo = FALSE, fig.cap = "Reply showing link to code on GitHub.", fig.alt = "Screenshot of my reply, giving the GitHub link to another file containing the function definition that answered the question.", out.width="70%", fig.align = "center"}
...
```{r, echo = FALSE, fig.cap = "Example of GitHub showing who wrote each last line of a file.", fig.alt = "Screenshot of GitHub blame page, identifying the last person who edited each line of code.", width="130%", fig.align = "center"}
knitr::include_graphics("blame.png")
```

   Though you'll often find that it was you all along:

```{r, echo = FALSE, fig.cap = "Amusing cartoon based on the storyline in every Scooby Doo episode. ", fig.alt = "Cartoon showing that often you'll look up who wrote a piece of code and realise it was you all along; based on the popular Scooby Doo cartoon series.", width="100%", fig.align = "center"}
...
```{r, echo = FALSE, fig.cap = "Example of GitHub Issues.", fig.alt = "Screenshot of example GitHub Issues; click on the Issues tab in any repository to see them.", width="100%", fig.align = "center"}
...
```{r, echo = FALSE, fig.cap = "Screenshot of basic shell commands.", fig.alt = "Screenshot of showing that dir command lists the directory contents, and cd.. moves back up.", width="100%", fig.align = "center"}
...
Okay, now for Video 2 (click on the screenshot below; video is 32 minutes):
...
```{r, echo = FALSE, fig.cap = "Screenshot of using git difftool.", fig.alt = "Screenshot showing changed text on the right-hand side.", width="100%", fig.align = "center"}
...
That is the basic workflow. Here is Video 3 (click on the screenshot; video is
21 minutes):
...
```{r, echo = FALSE, fig.cap = "Example of a lengthy error message when trying to push; essentially it's just telling you to fetch before trying to push.", fig.alt="Screenshot of an error message when trying to push, saying that the problem is usually due to someone else having pushed commits that you have not yet fetched, and that you should next fetch those commits.", width="100%", fig.align = "center"}
...
```{r, echo = FALSE, fig.cap = "Example of output when having 8 commits to push but then having to fetch and then rebase.", fig.alt = "Screenshot showing yellow
 text with up and down arrows, which I think of as meaning I have fetched commits and just need to rebase.", width="100%", fig.align = "center"}
...
Here is Video 4 (click on the screenshot; video is 15 minutes):
...
With Git you can go back to any previous state of your repository.
...
`r colorize("go back to any previous commit in your repository")`.
...
Consequently, your workflow is less cluttered and more tractable than having
  ...
  as this nightmare shown earlier:
...
```{r, echo = FALSE, fig.cap = "Example of why you shouldn't mess with the .git directory, as you get scary error messages and have to start again.", fig.alt = "Screenshot of error messages you can get if you mess with the .git directory, as just described.", width="100%", fig.align = "center"}
...
```{r, echo = FALSE, fig.cap = "Example screenshot of using Git in the RStudio terminal.", fig.alt = "Screenshot showing you can just type the Git commands in the Terminal of RStudio.", width="100%", fig.align = "center"}
...
```{r, echo = FALSE, fig.cap = "Screenshot of the Git buttons in RStudio.", fig.alt = "Screenshot of the Git RStudio interface.", width="100%", fig.align = "center"}
...
```{r, echo = FALSE, fig.cap = "Screenshot of the Git commit message window in RStudio.", fig.alt = "Screenshot of the window that pops open to write a commit message in RStudio.", width="100%", fig.align = "center"}
