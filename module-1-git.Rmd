...
computer, and also programs do get updated.
...
the repository example in the first video).
...
With one of the above two options installed when you click on a *READMEmd* file
you can edit the file and also see the rendered (formatted) version.
