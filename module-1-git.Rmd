...
**GOT TO HERE - checking with Chris about the file**

### "Cloning" the git-course repository - delete me in a sec
...
* Use your favourite editor to edit the new file (not the one in git-course/misc).
