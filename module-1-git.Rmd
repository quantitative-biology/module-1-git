...
It seems best to accept the default options, except:
 ...
 - , as it says, you probably want to switch from Vim (unless you use Vim) as the default editor.  TODO: though I think this is only for Git
pop-up windows, not your default editor. So Notepad okay.
