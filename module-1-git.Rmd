...
knitr::include_graphics("../module-1-git/images/hake-picture.png",
                        error = FALSE)
```
...
knitr::include_graphics("../module-1-git/images/interim.png",error = FALSE)
```
...
knitr::include_graphics("../module-1-git/images/proposalEmail.png",error = FALSE)
```
...
knitr::include_graphics("../module-1-git/images/dogsBreakfast.png",error = FALSE)
```
...
knitr::include_graphics("../module-1-git/images/MEEcodeQuest.png",error = FALSE)
```
...
knitr::include_graphics("../module-1-git/images/MEEcodeAnswer.png",error = FALSE)
```
...
knitr::include_graphics("../module-1-git/images/blame.png",error = FALSE)
```
