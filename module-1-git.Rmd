...
knitr::include_graphics("interim.png", error = FALSE)
```
...
knitr::include_graphics("EAversions.png",error = FALSE)
```
...
knitr::include_graphics("proposalEmail.png",error = FALSE)
```
...
knitr::include_graphics("dogsBreakfast.png",error = FALSE)
```
...
knitr::include_graphics("MEEcodeQuest.png",error = FALSE)
```
...
knitr::include_graphics("MEEcodeAnswer.png",error = FALSE)
```
...
knitr::include_graphics("blame.png",error = FALSE)
```
...
knitr::include_graphics("scooby-blame.png",error = FALSE)
```
...
knitr::include_graphics("hakeIssues21.png",error = FALSE)
```
...
knitr::include_graphics("shell-commands.png",error = FALSE)
```
