...
TODO: Andy re-install as needs later version.
...
TODO: Andy add to this if necessary.
...
GitHub website. You don't want to have to enter a password every time.

TODO: Andy needs to reinstall a recent version of Git (currently has 2.14.1, but
`?gitcreds::gitcreds_set` says to get 2.29 at least, though that's only for
multiple accounts I think. Earlier help it says mine is okay.
