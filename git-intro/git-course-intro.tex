...
saying that you want to include a message. Since we usually want to do both of
...
TODO: put later:    Note that you still edit and save your files in the usual way. If you don't
  commit you will still have the latest versions of your files on your computer
