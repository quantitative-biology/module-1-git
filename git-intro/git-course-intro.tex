...
We will show examples of:
  ...
  repository. You need to deal with these first by \lst{git f} and then \lst{git
    rebase}.
...
\frame{\frametitle{Fixing a conflict}
  \bi
    \item As mentioned, a {\red conflict} happens when two people have edited {\red the same line(s)
      of the same file}.
