...
\frame{\frametitle{Congratulations}
  Those are the few basic commands and functionality needed to collaborate with Git
  and \gh. It takes a bit of practice, but it is very powerful.

  The following slides give extra background that should improve your
  understanding, plus tips for improving your workflow. TODO
}


\frame{\frametitle{Other slides to add.....}
  Mention pull requests as you hear them a lot

  Including the following old ones and culling as necessary....
