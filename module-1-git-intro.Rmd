...
4. Collaborating - efficiently work with colleagues
5. Conflicts - fixing conflict changes (happens rarely)
...
So first sit back and listen, then go back through the slides yourself following the instructions, to become familiar with the basic ideas.
