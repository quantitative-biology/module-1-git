...
demonstrate the main concepts and ideas. The video is available [here](https://drive.google.com/drive/u/0/folders/1wLNNNn1e2zTKTjh8QAfTcS7L22990RRO)
and the slides from the talk are [to be added](TODO), though the notes below mostly
...
If you got Diffmerge installed okay, instead of `git diff` you can do `git
...
Okay, so in this [video](https://drive.google.com/file/d/1rqdFBnVg_zwP6SiW-KSTp6wZzAILDeeC/view?usp=sharing) we demonstrate the following:
...
knitr::include_graphics("./images/unable-to-pull.png",error = FALSE)
```
...
```{r, echo = FALSE, fig.alt = "", width="100%"}
knitr::include_graphics("./images/fix-the-pull.png",error = FALSE)
```
