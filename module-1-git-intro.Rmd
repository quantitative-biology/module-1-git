...
* It should say that you have an 'Untracked file' called _.gitignore_. You want
...
Exercise 2: Do the following, to get the idea of creating multiple files in a folder and
...
TODO: HERE - need to decide how to word this for the bookdown.
...
of as just implying I need to do a rebase:
